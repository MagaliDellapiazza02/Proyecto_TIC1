...
public class AddWorkerController {
        ...
        if (txtDocument.getText() == null || txtDocument.getText().equals("") ||
            ...
            try {
                ...
                try{
                    ...
                    PublicMethods.showAlert("ERROR", "Ingrese correctamente el documento");
                }
                ...
                //Setear company
                String company = userMgr.getCompanyByMail(Session.mail);
    ...
    void backButtonClicked(javafx.event.ActionEvent event) {
        PublicMethods.changeWindow(event, "/um/edu/uy/ui/user/airport/admin/AdminWorkers.fxml", "Admin Trabajadores");
    }
}
