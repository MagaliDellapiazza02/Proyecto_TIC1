...
@Component
@Controller
public class AirlineCreatorControllerCreoQueNoVa {
    ...
    void backButtonClicked(javafx.event.ActionEvent event) {
        ...
        try {
            ...
            Parent root = fxmlLoader.load(SignUpController.class.getResourceAsStream("/um/edu/uy/ui/user/airport/admin/AdminWorkers.fxml"));
